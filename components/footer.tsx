          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="font-serif text-xl font-semibold">ScholariumAI</span>
              </Link>
              <p className="text-sm text-white/70 leading-relaxed max-w-xs">
                AI-powered research intelligence for academics, researchers, and institutions worldwide.
              </p>
            </div>
            ...
            {/* Resources */}
            <div>
              <h3 className="text-sm font-semibold mb-4 text-white/90">Resources</h3>
              <ul className="space-y-3">
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-white/60">
              © {new Date().getFullYear()} ScholariumAI. All rights reserved.
            </p>
